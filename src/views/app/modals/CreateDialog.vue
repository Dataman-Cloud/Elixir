      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="100px" v-loading="loading" element-loading-text="数据加载中...">
        ...
        <el-collapse accordion class="advance" v-model="activeCollapse">
          <el-collapse-item name="advance" title="高级设置">
            ...
            <el-form-item v-for="(portMapping, index) in form.container.docker.portMappings" :key="index" class="healthCheck" v-if="form.container.docker.network === 'BRIDGE'">
              <el-row :gutter="12">
                <el-col :span="8">
                ...
                <el-col :span="8">
                  <el-form-item :prop="'container.docker.portMappings.' + index + '.servicePort'" :key="portMapping.index" :rules="[
            ...
            <el-form-item v-for="(healthCheck, index) in form.healthChecks" :key="index" class="healthCheck">
              <el-row :gutter="20">
                ...
                <el-col :span="10" v-if="healthCheck.protocol === 'HTTP'">
                  <el-form-item :prop="'healthChecks.' + index + '.path'" :key="index" :rules="[
                ...
                <el-col :span="10">
                  <el-form-item :prop="'healthChecks.' + index + '.gracePeriodSeconds'" :key="index" :rules="[
                ...
                <el-col :span="10">
                  <el-form-item :prop="'healthChecks.' + index + '.intervalSeconds'" :key="index" :rules="[
                ...
                <el-col :span="10">
                  <el-form-item :prop="'healthChecks.' + index + '.timeoutSeconds'" :key="index" :rules="[
                ...
                <el-col :span="10">
                  <el-form-item :prop="'healthChecks.' + index + '.maxConsecutiveFailures'" :key="index" :rules="[
                ...
                <el-col :span="10" v-if="form.container.docker.network === 'BRIDGE'">
                  <el-form-item :prop="'healthChecks.' + index + '.portIndex'" :key="index" :rules="[
                ...
                <el-col :span="10" v-else>
                  <el-form-item :prop="'healthChecks.' + index + '.port'" :key="index" :rules="[
